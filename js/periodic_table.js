...
const Reader = document.getElementById("reader-element-name");
var TypeOfReading = "All";
Reader.addEventListener("click", function(e) {
  e.preventDefault();
  let readText = '';
  if (TypeOfReading == "All") {
    TypeOfReading = "Symbol";
    readText = Reader.getAttribute("data-AllName");
  } else {
    TypeOfReading = "All";
    readText = Reader.getAttribute("data-Symbol");
    readText = SpiltSymbol(readText);
...
function correctReaderData(elementName) {
  let obj = ElementsSymbol[elementName];
  let AllName, Symbol;
  if (obj) {
    AllName = elementName;
    Symbol = obj;
  ...
  Reader.setAttribute("data-AllName", AllName);
  Reader.setAttribute("data-Symbol", Symbol);
  TypeOfReading = "Symbol";
}

function removeReaderData() {
  Reader.setAttribute("data-AllName", '');
  Reader.setAttribute("data-Symbol", '');
}
...
function openModal() {
  if (!isOpen) {
    ...
    addClass("--is-visible", Reader, 120);
...
function closeModal(event) {
  ...
  if (
    ...
    removeClass("--is-visible", Reader, 0);
